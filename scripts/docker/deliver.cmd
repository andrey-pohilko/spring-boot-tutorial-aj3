...
ssh root@49.12.229.158 "docker stop spring-boot-tutorial-aj3"
ssh root@49.12.229.158 "docker rm spring-boot-tutorial-aj3"


@rem build docker with tag
ssh root@49.12.229.158 "cd /var/lib/spring-boot-tutorial-aj3 && docker build -t anoxis/spring-boot-tutorial-aj3-image ."
