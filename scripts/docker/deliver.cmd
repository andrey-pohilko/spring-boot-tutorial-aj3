...
ssh root@49.12.229.158 ^
        docker run --restart unless-stopped -d -p 9000:9000 --rm ^
                   -n spring-boot-tutorial-aj3 spring-boot-tutorial-aj3-image
...
rem -n spring-boot-tutorial-aj3 - assign name to container
rem --rm remove when container is stopped